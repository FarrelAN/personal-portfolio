...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <div>
      <div
        className="h-52 md:h-72 bg-center lg:bg-center rounded-t-xl relative group md:bg-top"
      ...
      <div className="text-white text-justify rounded-b-xl mt-2 bg-[#181818] py-6 px-4">
